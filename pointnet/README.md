...
example:
---->python train_segmentation.py --dataset '/home/sjtu/wjx/pointnet.pytorch-master/shapenetcore_partanno_segmentation_benchmark_v0' --nepoch='5'
---->python train_classification.py --dataset /home/sjtu/wjx/pointnet.pytorch-master/shapenetcore_partanno_segmentation_benchmark_v0 --nepoch='5' --dataset_type 'shapenet'
```
